...
const ContentRow = ({ title, count, children, accent = false }: ContentRowProps) => {
    ...
    >
      <div className="mx-auto max-w-[1400px] px-6">
        <div className="mb-5 flex items-center justify-between">
          ...
          <button className="flex items-center gap-1 font-body text-xs text-muted-foreground transition-colors hover:text-primary group/btn">
            Explore All
